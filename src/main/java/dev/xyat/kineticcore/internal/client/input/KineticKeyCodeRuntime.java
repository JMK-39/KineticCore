...
/** Internal owner for platform keyboard key codes used by the public named-key enum. */
public final class KineticKeyCodeRuntime {
    private KineticKeyCodeRuntime() {
    }

    /** Resolves one public named keyboard key to the current platform key code. */
    public static int code(KineticKeyBindings.Key key) {
        return switch (key) {
            case UNKNOWN -> GLFW.GLFW_KEY_UNKNOWN;
            ...
            case NUM_0 -> GLFW.GLFW_KEY_0;
            case NUM_1 -> GLFW.GLFW_KEY_1;
            case NUM_2 -> GLFW.GLFW_KEY_2;
            case NUM_3 -> GLFW.GLFW_KEY_3;
            case NUM_4 -> GLFW.GLFW_KEY_4;
            case NUM_5 -> GLFW.GLFW_KEY_5;
            case NUM_6 -> GLFW.GLFW_KEY_6;
            case NUM_7 -> GLFW.GLFW_KEY_7;
            case NUM_8 -> GLFW.GLFW_KEY_8;
            case NUM_9 -> GLFW.GLFW_KEY_9;
