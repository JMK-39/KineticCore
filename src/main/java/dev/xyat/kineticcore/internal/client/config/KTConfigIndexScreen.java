...
public final class KTConfigIndexScreen extends KineticScreen {
    ...
    protected void buildUi() {
        ...
        addButton(
                ...
                24,
                72,
                KineticText.translatable("gui.done"),
                null,
                this::onClose
        );
    }
    ...
    protected void renderCanvasBackground(
        ...
        graphics.drawCenteredString(
                ...
                KineticText.translatable(
                        ...
                        Component.literal(String.valueOf(moduleModel.items().size())),
                        Component.literal(String.valueOf(registeredModules.size()))
                ),
                canvasWidth() / 2,
                72,
                0xFFAAAAAA
    ...
    private void renderModuleRows(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        try {
            for (int index = first; index < last; index++) {
                ...
                Component count = KineticText.translatable(
    ...
    protected void renderTooltips(
        ...
        lines.add(KineticText.translatable(
                "gui.kineticcore.config.module_summary",
                Component.literal(String.valueOf(hoveredModule.entryCount()))
        ));
