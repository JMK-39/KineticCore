...
/** Internal implementation for Kinetic manual crawling state and pose ownership. */
public final class KineticCrawlingRuntime {
    public static final String CRAWLING_TAG = "IsCrawling";

    private KineticCrawlingRuntime() {
    }
    ...
    public static void setCrawling(LivingEntity entity, boolean crawling) {
        ...
        if (crawling) startManualCrawling(entity);
        else stopManualCrawling(entity);
    }
